...
<head>
    ...
    <script type="text/javascript">
        function read(hb_id) {
            var b = "reply?hb.ty=0&hb.id=" + hb_id;
            alert("这里我不会传值T_T 具体代码在zhoubao\\shoujiangxianglist.jsp里")
            ...
            <table id="subtree1" width="900px;" style="margin-left: auto;margin-right: auto;">
                ...
                <s:iterator value="hbs" status="status" var="info">
                    <tr align="center">
                        ...
                        <s:elseif test="#info.ty==1">
                            <td id="td">
                                月报
                            </td>
                        </s:elseif>
                        <s:elseif test="#info.ty==2">
                            <td id="td">
                                年报
                            </td>
                        </s:elseif>
                        ...
                        <td id="td" style="border-right: thin dashed gray;" align="center">
                            ...
                            <%--<a href="reply?hb.ty=0">--%>
                                <input type="button" class="inpu1" onclick="read('$(info.id)')" value='批复'/>
                            <%--</a>--%>
                        </td>
                    </tr>
                </s:iterator>
