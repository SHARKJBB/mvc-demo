...
<body>
<div id="bott1" style="margin-left: 10px">
    <div id="bott2">
        <h2>未读周报</h2>
    </div>
    <div id="bott3">
        <table id="subtree1" width="375px;" style="margin-left: auto;margin-right: auto;">
            ...
            <s:iterator value="noreplyzbs" status="status" var="info">
                <tr align="center">
                    <td id="td">
...
<div id="bott1_1" style="margin-left: 10px">
    <div id="bott2">
        <h2>未读月报</h2>
    </div>
    <div id="bott3">
        <table id="subtree1" width="375px;" style="margin-left: auto;margin-right: auto;">
            ...
            <s:iterator value="noreplyybs" status="status" var="info">
                <tr align="center">
                    <td id="td">
                        <s:property value="#status.count"/>
                    </td>
...
<div id="bott1_2" style="margin-left: 10px">
    <div id="bott2">
        <h2>未读年报</h2>
    </div>
    <div id="bott3">
        <table id="subtree1" width="375px;" style="margin-left: auto;margin-right: auto;">
            ...
            <s:iterator value="noreplynbs" status="status" var="info">
                <tr align="center">
                    <td id="td">
                        <s:property value="#status.count"/>
                    </td>
