...
<div style="width: 500px;height: 680px;float: left;margin-left: 15px;margin-top: 20px;">
    ...
    <div class="div2">
        <form action="listwf" method="post">
            <input id="inpu_hb" name="hbmesg" type="text" class="inpu" value="请输入员工姓名或工号" onfocus="qingkong(id)"
                   onblur="likai(id)"/>
            <div class="div3">
    ...
    <table width="500px;" align="center" border="1px;">
        ...
        <s:iterator value="#session.wfhbus" status="status" var="info">
            <s:if test="#info.ty!='月报'">
                <tr align="center">
                    <td width="110px;">
                        <s:property value="#info.ty"/>
                    </td>
                    <td width="50px;">
                        <s:property value="#status.count"/>
                    </td>
                    <td width="100px;">
                        <s:property value="#info.zyy"/>
                    </td>
                    <td width="110px;">
                        <s:property value="#info.userName"/>
                    </td>
                    <td width="130px;">
                        <s:property value="#info.gh"/>
                    </td>
                    <s:if test="#session.pow==2">
                        <td width="130px;">
                            <a href="javaScript:">
...
<div style="width: 500px;height: 680px;float: left;margin-left: 25px;margin-top: 20px;">
    ...
    <div class="div2">
        <form action="listu" method="post">
            <input id="inpu_hb1" name="hbmesg" type="text" class="inpu" value="请输入员工姓名或工号" onfocus="qingkong(id)"
                   onblur="likai(id)"/>
            <div class="div3">
                <input type="submit" class="inpu1" value='查询'/>
            </div>
        ...
        <s:iterator value="#session.users" status="status" var="info">
            <s:if test="#status.Even">
                <tr align="center">
                    ...
                    <td width="150px;">
                        <s:property value="#info.phone"/>
                    </td>
                </tr>
            </s:if>
            <s:elseif test="#status.Odd">
                <tr align="center" style="background-color: #b0c0ca;">
                    <td width="50px;">
                        <s:property value="#status.count"/>
                    </td>
                    <td width="100px;">
