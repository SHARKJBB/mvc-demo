...
<div class="wrap">
    ...
    <form action="login?f=0" method="post">
        <div class="inp">
            <div class="inp_a">
            </div>
            <div class="inp_b">
                <span class="u"></span>
                <input id="inp_userName" class="inpu" type="text" name="user.gh" value="请输入工号" onfocus="qingkong()"
                       onblur="likai()"/>
            </div>
            <div class="inp_c">
                <p id="u_p"></p>
            ...
            <div class="inp_p">
                <span class="p"></span>
                <input id="inp_pswd" class="pswd" type="text" name="user.password" value="请输入密码" onfocus="qk()"
                       onblur="lk()"/>
            </div>
            <!-- 密码提示框与登录错误提示共用一个。 -->
            <div class="inp_p_c">
