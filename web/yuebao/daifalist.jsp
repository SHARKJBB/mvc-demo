                ...
                <form action="" method="post">
                    <table id="subtree1" width="600px;" style="margin-left: auto;margin-right: auto;">
                        <tr align="center">
                            ...
                            <td id="td" bgcolor="#63ebfb" width="20%">月期</td>
                        ...
                        <tr align="center">
                            ...
                            <td id="td" style="border-right: thin dashed gray;" align="left">
                                <div style="padding-left: 13px;">
                                    <!-- 通过对比当前汇报的月期数和真实的月期数判断当前汇报是否过期 存在两个并列的if-->
                                    <s:if test="#info.zyys==#info.nowZyys">
                                        <a style="color: blue;text-decoration: underline;"
                                           href="toSendhb?hb.ty=1">发送</a>
                                        &nbsp;
                                        <a style="color: blue;text-decoration: underline;"
                                        href="edithb?hb.ty=1">编辑</a>
                                        &nbsp;
                                        <a style="color: blue;text-decoration: underline;"
                                           href="deletehb?hb.ty=1">删除</a>
                                    </s:if>
                                    <s:if test="#info.zyys!=#info.nowZyys">
